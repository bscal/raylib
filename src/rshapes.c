...
static Raylib_Rectangle texShapesRec = { 0.0f, 0.0f, 1.0f, 1.0f };    // Texture source rectangle used on shapes drawing
...
void SetShapesTexture(Texture2D texture, Raylib_Rectangle source)
{
    ...
    if ((texture.id == 0) || (source.width == 0) || (source.height == 0))
    {
        ...
        texShapesRec = (Raylib_Rectangle){ 0.0f, 0.0f, 1.0f, 1.0f };
    }
    else
    {
        texShapes = texture;
...
Raylib_Rectangle GetShapesTextureRectangle(void)
{
    return texShapesRec;
}
...
void DrawPixelV(Vector2 position, Color color)
{
    ...
    Raylib_Rectangle shapeRect = GetShapesTextureRectangle();
...
{
    DrawRectanglePro((Raylib_Rectangle){ position.x, position.y, size.x, size.y }, (Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle
void DrawRectangleRec(Raylib_Rectangle rec, Color color)
{
    DrawRectanglePro(rec, (Vector2){ 0.0f, 0.0f }, 0.0f, color);
}

// Draw a color-filled rectangle with pro parameters
void DrawRectanglePro(Raylib_Rectangle rec, Vector2 origin, float rotation, Color color)
{
    Vector2 topLeft = { 0 };
    Vector2 topRight = { 0 };
...
{
    DrawRectangleGradientEx((Raylib_Rectangle){ (float)posX, (float)posY, (float)width, (float)height }, top, bottom, bottom, top);
}

// Draw a horizontal-gradient-filled rectangle
void DrawRectangleGradientH(int posX, int posY, int width, int height, Color left, Color right)
{
    DrawRectangleGradientEx((Raylib_Rectangle){ (float)posX, (float)posY, (float)width, (float)height }, left, left, right, right);
}

// Draw a gradient-filled rectangle
void DrawRectangleGradientEx(Raylib_Rectangle rec, Color topLeft, Color bottomLeft, Color topRight, Color bottomRight)
{
    rlSetTexture(GetShapesTexture().id);
    Raylib_Rectangle shapeRect = GetShapesTextureRectangle();
...
void DrawRectangleLinesEx(Raylib_Rectangle rec, float lineThick, Color color)
{
    ...
    Raylib_Rectangle top = { rec.x, rec.y, rec.width, lineThick };
    Raylib_Rectangle bottom = { rec.x, rec.y - lineThick + rec.height, rec.width, lineThick };
    Raylib_Rectangle left = { rec.x, rec.y + lineThick, lineThick, rec.height - lineThick*2.0f };
    Raylib_Rectangle right = { rec.x - lineThick + rec.width, rec.y + lineThick, lineThick, rec.height - lineThick*2.0f };
...
void DrawRectangleRounded(Raylib_Rectangle rec, float roundness, int segments, Color color)
{
...
void DrawRectangleRoundedLines(Raylib_Rectangle rec, float roundness, int segments, Color color)
{
    DrawRectangleRoundedLinesEx(rec, roundness, segments, 1.0f, color);
}

// Draw rectangle with rounded edges outline
void DrawRectangleRoundedLinesEx(Raylib_Rectangle rec, float roundness, int segments, float lineThick, Color color)
{
    ...
    if (roundness <= 0.0f)
    {
        DrawRectangleLinesEx((Raylib_Rectangle){rec.x-lineThick, rec.y-lineThick, rec.width+2*lineThick, rec.height+2*lineThick}, lineThick, color);
        return;
    }
...
bool CheckCollisionPointRec(Vector2 point, Raylib_Rectangle rec)
{
...
bool CheckCollisionRecs(Raylib_Rectangle rec1, Raylib_Rectangle rec2)
{
    bool collision = false;
...
bool CheckCollisionCircleRec(Vector2 center, float radius, Raylib_Rectangle rec)
{
    bool collision = false;
...
Raylib_Rectangle GetCollisionRec(Raylib_Rectangle rec1, Raylib_Rectangle rec2)
{
    Raylib_Rectangle overlap = { 0 };
